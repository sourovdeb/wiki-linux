...
- extra_desktop_instance_detected: no

## Processes
```
17275 /home/sourov/.config/open-webui/python/bin/python /home/sourov/.config/open-webui/python/bin/open-webui serve --host 127.0.0.1 --port 8080
```
