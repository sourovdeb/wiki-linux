...
- [[user/notes/README|Notes]] — Short-form notes, logs, and scratch pages live here.  `space`
- [[user/notes|Notes]] — Short-form notes, logs, and scratch pages live here.  `space`
- [[user/projects/README|Projects]] — Longer-running work gets documented here.  `space`
- [[user/projects|Projects]] — Longer-running work gets documented here.  `space`
- [[user/research/README|Research]] — References, sources, and experiments live here.  `space`
- [[user/research|Research]] — References, sources, and experiments live here.  `space`
- [[user/README|User Space]] — This space holds personal notes, projects, and research for the machine owner.  `space`
- [[user/projects/wiki-linux|Wiki-OS Project]] — This page tracks the core Wiki-OS project that powers the local wiki layer.  `project` `wiki-os`
